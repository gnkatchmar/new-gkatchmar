...
const Restaurants = () => (
  <div>
    ...
    <h3>Lunch/Dinner</h3>
      ...
      <p><b>3 ½ stars</b>: Gold Dust Meridian&nbsp;(twice), Iorio&nbsp;(twice), Picnic House, Hoda’s Middle-Eastern Cuisine, Bit House Saloon, Biwa*, Juan Colorado, <del>Mike's Drive-In&nbsp;(twice)</del>, La Sirenita, <del>Bywater Grocery</del>, Ringside Fish House, <del>Bar Dobre</del>, Kenny &&nbsp;Zuke’s Delicatessen, Taqueria Los Gorditos (NW Davis, twice), La Fondita&nbsp;(Salem), The Goose, Hale Pele, Grassa, DeNicola's (twice), Sapphire Hotel, Teote, Roost, <del>Lucky Strike&nbsp;(thrice)</del>, Nicholas II*, <del>Oso</del>, Tapalaya*, <del>Tabla</del>, Olympic Provisions&nbsp;(Eastside), El Cubo de Cuba&nbsp;(four times), Bazi Bierbrasserie&nbsp;(twice), El Sombrero Tapatio, Uno Mas, <del>Club&nbsp;21</del></p>

      <p><b>3 stars</b>: Pollo Norte 2.0 (twice), La Panza, Mama Leo’s, St. Jack, Noraneko (twice), Yen Ha, The Lamp&nbsp;(four times), Hot Lips Pizza&nbsp;(twice), Sizzle Pie&nbsp;(twice), Tambayan, Fujiyama Sushi and Grill, Dove Vivi, Fogo de Chao, Salvador Molly’s, Double Dragon&nbsp;(twice), Two Brothers Café &&nbsp;Grill&nbsp;(twice), Hop City Tavern, The Ranger Station, Dan and Louis Oyster Bar, Hawthorne Hophouse&nbsp;(twice), <del>Branch Whiskey Bar</del>, <del>SubRosa</del>, <del>Kenny &&nbsp;Zuke’s Deli Bar</del>, The Brooklyn House, Laurelwood Brewpub, Hopworks Urban Brewery, Slowburger&nbsp;(twice), Delta Café&nbsp;(thrice), Knuckle Sandwich&nbsp;(twice), Double&nbsp;Barrel, Migration Brewing (twice), Nick's Famous Coney Island (twice), Fresh Roll (thrice)</p>

    <h3>Breakfast/Brunch (in order)</h3>

      <p><del>Simpatica&nbsp;(thrice)*</del>, Screen Door, Country Cat&nbsp;(four times), Beach Dog Cafe&nbsp;(Lincoln City), Pepper Box&nbsp;(twice), Pine State Biscuits&nbsp;(five times), Petite Provence&nbsp;(Division)&nbsp;(three times), Muscadine, Redwood&nbsp;(twice), Zell’s&nbsp;(three times), St. Honoré Bakery, Midpoint Café&nbsp;(twice), Doug Fir&nbsp;(seven times), Jam&nbsp;(five times), Block House Cafe (Dayton), Ya Hala (thrice), Cheryl's on 12th, Cadillac Café&nbsp;(nine times), The Waffle Window&nbsp;(thrice), Off the Waffle, Utopia Café&nbsp;(thrice), <del>Kerns Kitchen&nbsp;(twice)</del>, Bridges Café&nbsp;(twice), <del>Blue Pig Café</del>, Sanborn's, Hazel Room&nbsp;(twice), Chez Machin&nbsp;(twice), Swift Lounge&nbsp;(no longer serve brunch), City State Diner, Slappy Cakes&nbsp;(thrice), Sckavone’s, Tabor Bread, New Deal Cafe, Brick and Mortar&nbsp;(Albany), Tom's Restaurant (twice), Cup and Saucer (twice), Bottle +&nbsp;Kitchen&nbsp;(thrice), Le Bistro Montage&nbsp;(twice), Firehouse Grill&nbsp;(Seaside), Cameo Café, Junior's Cafe, Milo's City Cafe (twice), Cricket Café&nbsp;(twice), EastBurn, Holman's, Hawthorne Hophouse</p>
